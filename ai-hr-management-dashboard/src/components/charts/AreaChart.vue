...
<template>
  <div class="grove-chart">
    <svg :viewBox="`0 0 ${width} ${height}`" role="img" aria-label="Headcount trend">
      <line
        v-for="tick in ticks"
        :key="tick"
        :x1="padX"
    ...
    <div class="grove-chart-labels">
      <span v-for="label in labels" :key="label">{{ label }}</span>
    </div>
    <div class="grove-chart-legend">
