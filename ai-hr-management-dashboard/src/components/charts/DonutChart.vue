...
<template>
  <div class="grove-donut">
    <svg viewBox="0 0 160 160" role="img" :aria-label="centerLabel">
      <circle cx="80" cy="80" :r="radius" class="grove-donut-track" />
      <path
        ...
        stroke-linecap="butt"
      />
      <text x="80" y="76" text-anchor="middle" class="grove-donut-value">
        {{ centerValue ?? total }}
      </text>
      <text x="80" y="96" text-anchor="middle" class="grove-donut-label">
        {{ centerLabel }}
      </text>
    </svg>
    <ul class="grove-donut-legend">
