...
<template>
  <div class="hbr-hbar-list" role="list">
    <div v-for="item in items" :key="item.name" class="hbr-hbar" role="listitem">
      ...
      <div class="hbr-hbar-track">
        <div
          class="hbr-hbar-fill"
          :style="{ width: widthFor(item), background: item.color || 'var(--hbr-accent)' }"
        />
      </div>
    </div>
  </div>
