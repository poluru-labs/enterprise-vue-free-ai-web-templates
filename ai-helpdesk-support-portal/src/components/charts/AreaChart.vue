...
<template>
  <div class="lumen-chart">
    <svg :viewBox="`0 0 ${width} ${height}`" role="img" aria-label="Ticket volume">
      <line
        v-for="tick in ticks"
        :key="tick"
        :x1="padX"
    ...
    <div class="lumen-chart-labels">
      <span v-for="label in labels" :key="label">{{ label }}</span>
    </div>
    <div class="lumen-chart-legend">
